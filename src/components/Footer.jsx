function Footer() {
    return (
        <footer className="light-gray-bg-custom dark:bg-zinc-800  fixed inset-x-0 bottom-0 ">
            {/* <div className="mx-auto max-w-screen-2xl p-9 py-6 lg:py-8">
                ...
                <div className="sm:flex sm:justify-between text-center sm:text-left mx-auto max-w-screen-2xl p-9 py-6 lg:py-8">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
                        © 2024 Afriland First Bank. All Rights Reserved.
                    </span>
                </div>
        </footer>
    );
